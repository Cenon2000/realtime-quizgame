...
function commitCategoryCount(board: 1 | 2, raw: string) {
  ...
  return (
    <div className="flex flex-col gap-4 h-[80svh] md:h-[80vh] min-h-0">
  ...
  <label className="flex flex-col gap-1 text-sm">
    ...
    <div className="flex items-center gap-2">
      ...
      >
       ...
       <div className="md:flex-[2] flex-1 min-h-0 overflow-y-auto pb-8 border border-slate-700 rounded-xl p-3 space-y-4 bg-slate-900/50">
